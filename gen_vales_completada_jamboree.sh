...
./run_python.sh src/gen_letter_2x4.py -c $qty -p Lata_Bebida Completos Promocion -n ${name}_${qty}_completada.pdf -o assets/img/logo_grupo_scout.png -e assets/img/logo_jamboree.png 
